...
CREATE MATERIALIZED VIEW scheduled_actual AS (
	...
	SELECT DISTINCT S.trip_id, S.trip_headsign, S.stop_name, S.stop_lat, S.stop_lon, S.stop_sequence, S.next_day, S.arrival_time scheduled_time, SA.actual_time actual_time
